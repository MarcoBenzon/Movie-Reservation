<?php require_once 'processue.php'; ?>
<?php
session_start();
...
<div class="container">
	...
	?>
	<form action="emovieu.php" method="post">
		<div class="row">
			<div class="col-sm-9">
	...
	<div class="col-sm-12">
	    <table class="table">
			...
			<tr>
				...
				<a href="emovieu.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete This Movie?')">Delete</a>
				</td>
			</tr>
		</table>
	</div>
